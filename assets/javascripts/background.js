class AnimatedTriangulatedBackground {
    ...
    redraw() {
        ...
        this.context.strokeStyle = "rgba(127,127,127,0.1)"; // opacity creates more aliased lines
        this.context.stroke();

        // Voronoi
        this.context.beginPath();
        voronoi.map(this.drawCell.bind(this));
        this.context.strokeStyle = "rgba(127,127,127,0.2)"; // opacity creates more aliased lines
        this.context.stroke();
    }
